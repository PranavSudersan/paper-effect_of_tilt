...
\title{Mechanisms of detachment in hairy adhesive systems}
...
state in bio-inspired artificial fibrillar adhesives without the need of asymmetric
structures.
\end{abstract}
...
In the energy balance approach, adhesion is usually characterized by ``work
...
had identified two regimes of single hair detachment: 1) a \emph{flaw sensitive}
regime, where, for large hair raidus, contact failure occurs due to crack propagation, 
...
where, for small hair raidus, the contact interface fails simultaneously, leading to high
...
Simplifying, we get (see Appendix for derivation):
...
\textgreek{m}N and spring constant, $k_{h}=0.5\times25=12.5$ N m\protect\textsuperscript{-1}.
...
that both the distal and proximal pads are combined to be a single
...
hinge H\textsubscript{2} to be free such that the two pads can behave
...
to achieve reversible adhesion in bio-inspired artificial fibrillar adhesives
without the need of asymmetric structures.

\section{Acknowledgment}

We are grateful to Hans-J\"{u}rgen Butt and Thomas Endlein for reviewing the text, and thank Ren\textcyr{\`\cyre} Hensel and
Bat-El Pinchasik for fruitful discussions. This work was supported by the Deutsche Forschungsgemeinschaft
