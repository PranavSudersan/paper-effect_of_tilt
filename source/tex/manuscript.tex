...
of the hairs. In this study, we propose mechanisms by which
a hairy pad can be easily detached, even when the hairs possess no
asymmetry. Here, we examine the possible function of the leg joint and the claws.
Based on a spring-based model, we consider three modes
...
Our proposed model illustrates the design advantage provided by such fibrillar
...
state in bio-inspired fibrillar adhesives, by incorporating artificial joints and claws into their design, 
...
a fibrillar adhesive pad can be attained by 1) increasing the stress concentration
...
force-balance approach is used to quantify the net adhesion \cite{RN117, RN253}.
...
The fibrillar adhesive pad is assumed to be a one dimensional array of $N_{t}$
...
\begin{figure}[H]
\includegraphics{Figure1-model_schematic}\caption{Spring contact model of a fibrillar adhesive pad. The pad consists of
...
\begin{figure}[H]
\includegraphics{Case1-Fixed_pull}\caption{Force distance curves for a fibrillar adhesive pad, pulled vertically upwards with
...
\includegraphics{Case2-Free_pull}\caption{Force distance curves for a fibrillar adhesive pad, pulled vertically upwards with
...
\begin{figure}[H]
\includegraphics{Case3-Fixed_flex}\caption{Force curves for a fibrillar adhesive pad detached by flexing it about the claw.
...
one can think of several strategies to detach a fibrillar adhesive pad
...
in the adhesion of a fibrillar system. Such a condition can be achieved
...
observations of leg detachment in dock beetles and highlights possible role of the leg joint and claws to 
